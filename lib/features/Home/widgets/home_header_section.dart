...
class HomeHeaderSection extends StatefulWidget {
    const HomeHeaderSection({
      ...
      this.onFilterChanged, // 💥 NEW: Callback for when the filter is changed
    });
  
    final bool isMyitemsScreen;
    final bool isSettingsScreen;
    final ValueChanged<String>? onSearchChanged;
    final ValueChanged<String>? onFilterChanged; // 💥 NEW PROPERTY
...
class _HomeHeaderSectionState extends State<HomeHeaderSection> {
    // NOTE: This state manages the selected item inside the dropdown button itself.
    // The actual filtering logic is handled by the parent via the callback.
    String _selectedFilter = CustomTexts.allItemsFilter; 
          ...
          child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                onChanged: (String? newValue) {
                  setState(() {
                    _selectedFilter = newValue!;
                    // 💥 Trigger the callback function in the parent screen!
